...
define( 'LR_OAUTH_USER_ERROR' , 20002 );
define( 'LR_OAUTH_DB_ERROR' , 20004 );
define( 'LR_OAUTH_NOT_IMPLEMENT_YET' , 20005 );
define( 'LR_OAUTH_ARGS_ERROR' , 20006 );
define( 'LR_OAUTH_DB_EMPTY_RESULT' , 20007 );
	...
	public function addClient($client_id, $client_secret, $redirect_uri) {
		//try {
			...
			*/
			...
			$stmt = 'INSERT INTO ' . self::TABLE_CLIENTS . ' (client_id, client_secret, redirect_uri) VALUES (?i, ?s, ?s)';
